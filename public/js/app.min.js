...
function ssc_init() {
    if (document.body) {
        var e = document.body
          ...
          , i = e.scrollHeight;
        if (ssc_root = document.compatMode.indexOf("CSS") >= 0 ? t : e,
        ssc_activeElement = e,
        ssc_initdone = !0,
        top != self)
            ssc_frame = !0;
    ...
    !ssc_pending) {
        var o = function() {
            for (var r = +new Date, s = 0, a = 0, l = 0; l < ssc_que.length; l++) {
                ...
                c.lastX += h,
                c.lastY += p,
                d && (ssc_que.splice(l, 1),
                l--)
            }
            if (t) {
                var g = e.scrollLeft;
                e.scrollLeft += s,
                s && e.scrollLeft === g && (t = 0)
            }
            if (n) {
                var m = e.scrollTop;
                e.scrollTop += a,
            ...
            t || n || (ssc_que = []),
            ssc_que.length ? setTimeout(o, i / ssc_framerate + 1) : ssc_pending = !1
        };
        setTimeout(o, 0),
        ssc_pending = !0
    }
...
function ssc_keydown(e) {
    ...
    var i = 0
      ...
      , s = r.clientHeight;
    switch (r == document.body && (s = window.innerHeight),
    e.keyCode) {
    case ssc_key.up:
        o = -ssc_arrowscroll;
        break;
...
function ssc_directionCheck(e, t) {
    e = e > 0 ? 1 : -1,
    t = t > 0 ? 1 : -1,
    (ssc_direction.x !== e || ssc_direction.y !== t) && (ssc_direction.x = e,
    ssc_direction.y = t,
    ssc_que = [])
}
function ssc_pulse_(e) {
    var t, n, i;
    return 1 > (e *= ssc_pulseScale) ? t = e - (1 - Math.exp(-e)) : (n = Math.exp(-1),
    e -= 1,
    i = 1 - Math.exp(-e),
    t = n + i * (1 - n)),
    t * ssc_pulseNormalize
}
...
function loadGoogleMapsAPI() {
    ...
    e.src = "https://maps.googleapis.com/maps/api/js?callback=loadMap&key=" + t,
...
if (function(e, t) {
    ...
    function r(e, t, n) {
        ...
        }) : Ee.test(t) ? pe.filter(t, e, n) : (t = pe.filter(t, e),
    ...
    function v(e, t) {
        for (var n, i, o = [], r = 0, s = e.length; r < s; r++)
            ...
            t ? ("none" === n && (o[r] = $e.get(i, "display") || null,
            o[r] || (i.style.display = "")),
            "" === i.style.display && We(i) && (o[r] = m(i))) : "none" !== n && (o[r] = "none",
            $e.set(i, "display", n)));
        for (r = 0; r < s; r++)
    ...
    function w(e, t, n, i, o) {
        for (var r, s, a, l, c, u, d = t.createDocumentFragment(), f = [], h = 0, p = e.length; h < p; h++)
            if ((r = e[h]) || 0 === r)
                if ("object" === pe.type(r))
                    pe.merge(f, r.nodeType ? [r] : r);
                else if (Ye.test(r)) {
                    for (s = s || d.appendChild(t.createElement("div")),
                    a = (Ue.exec(r) || ["", ""])[1].toLowerCase(),
                    l = Xe[a] || Xe._default,
                    s.innerHTML = l[1] + pe.htmlPrefilter(r) + l[2],
                    u = l[0]; u--; )
                        s = s.lastChild;
                    pe.merge(f, s.childNodes),
        ...
        h = 0; r = f[h++]; )
            if (i && pe.inArray(r, i) > -1)
                o && o.push(r);
            else if (c = pe.contains(r.ownerDocument, r),
    ...
    function O(e, t, i, o) {
        t = oe.apply([], t);
        var r, s, a, l, c, u, d = 0, f = e.length, h = f - 1, p = t[0], g = pe.isFunction(p);
        if (g || f > 1 && "string" == typeof p && !fe.checkClone && tt.test(p))
        ...
        s || o)) {
            for (l = (a = pe.map(y(r, "script"), k)).length; d < f; d++)
                c = r,
                d !== h && (c = pe.clone(c, !0, !0),
            ...
            if (l)
                ...
                d = 0; d < l; d++)
                    c = a[d],
                    Ve.test(c.type || "") && !$e.access(c, "globalEval") && pe.contains(u, c) && (c.src ? pe._evalUrl && pe._evalUrl(c.src) : n(c.textContent.replace(it, ""), u))
        }
        return e
    }
    function I(e, t, n) {
    ...
    function N(e, t, n) {
        ...
        !fe.pixelMarginRight() && rt.test(s) && ot.test(t) && (i = a.width,
        o = a.minWidth,
        r = a.maxWidth,
    ...
    function P(e, t, n, i, o) {
        ...
        for (r = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0; r < 4; r += 2)
            "margin" === n && (s += pe.css(e, n + Re[r], !0, o)),
            i ? ("content" === n && (s -= pe.css(e, "padding" + Re[r], !0, o)),
            "margin" !== n && (s -= pe.css(e, "border" + Re[r] + "Width", !0, o))) : (s += pe.css(e, "padding" + Re[r], !0, o),
            "padding" !== n && (s += pe.css(e, "border" + Re[r] + "Width", !0, o)));
        return s
    }
    function j(e, t, n) {
        var i, o = st(e), r = N(e, t, o), s = "border-box" === pe.css(e, "boxSizing", !1, o);
        return rt.test(r) ? r : (i = s && (fe.boxSizingReliable() || r === e.style[t]),
        "auto" === r && (r = e["offset" + t[0].toUpperCase() + t.slice(1)]),
        (r = parseFloat(r) || 0) + P(e, t, n || (s ? "border" : "content"), i, o) + "px")
    }
    function M(e, t, n, i, o) {
        return new M.prototype.init(e,t,n,i,o)
    }
    function R() {
        pt && (!1 === te.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(R) : e.setTimeout(R, pe.fx.interval),
        pe.fx.tick())
    }
    function W() {
    ...
    function U(e, t, n) {
        var i, o, r = 0, s = U.prefilters.length, a = pe.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (o)
                return !1;
            for (var t = ht || W(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), r = 0, s = c.tweens.length; r < s; r++)
                c.tweens[r].run(i);
        ...
        a--); a < l; a++)
            if (null != (e = arguments[a]))
                for (t in e)
                    n = s[t],
                    i = e[t],
                    s !== i && (c && i && (pe.isPlainObject(i) || (o = Array.isArray(i))) ? (o ? (o = !1,
                    r = n && Array.isArray(n) ? n : []) : r = n && pe.isPlainObject(n) ? n : {},
                    s[t] = pe.extend(c, r, i)) : void 0 !== i && (s[t] = i));
        return s
    }
    ,
    pe.extend({
    ...
    var be = function(e) {
        function t(e, t, n, i) {
            var o, r, s, a, l, u, f, h = t && t.ownerDocument, p = t ? t.nodeType : 9;
            if (n = n || [],
            "string" != typeof e || !e || 1 !== p && 9 !== p && 11 !== p)
                return n;
            if (!i && ((t ? t.ownerDocument || t : M) !== I && O(t),
            t = t || I,
            L)) {
                if (11 !== p && (l = ge.exec(e)))
                    if (o = l[1]) {
                        if (9 === p) {
                            ...
                            if (s.id === o)
                                return n.push(s),
                                n
                        } else if (h && (s = h.getElementById(o)) && P(t, s) && s.id === o)
                            return n.push(s),
                            n
                    } else {
                        if (l[2])
                ...
                if (w.qsa && !B[e + " "] && (!$ || !$.test(e))) {
                    if (1 !== p)
                        ...
                        for ((a = t.getAttribute("id")) ? a = a.replace(be, we) : t.setAttribute("id", a = j),
                        r = (u = E(e)).length; r--; )
                            u[r] = "#" + a + " " + d(u[r]);
                        f = u.join(","),
        ...
        function m(e, t, n, o, r, s) {
            ...
            r && !r[j] && (r = m(r, s)),
            i(function(i, s, a, l) {
                var c, u, d, f = [], h = [], m = s.length, v = i || p(t || "*", a.nodeType ? [a] : a, []), y = !e || !i && t ? v : g(v, f, e, a, l), b = n ? r || (i ? e : m || o) ? [] : s : y;
                if (n && n(y, b, a, l),
                o)
                    for (c = g(b, h),
                    o(c, [], a, l),
                ...
                if (i) {
                    if (r || e) {
                        ...
                        for (u = b.length; u--; )
                            (d = b[u]) && (c = r ? Z(i, d) : f[u]) > -1 && (i[c] = !(s[c] = d))
                    }
                } else
        ...
        function y(e, n) {
            var o = n.length > 0
              ...
              , s = function(i, s, a, l, c) {
                var u, d, f, h = 0, p = "0", m = i && [], v = [], y = x, b = i || r && T.find.TAG("*", c), w = R += null == y ? 1 : Math.random() || .1, C = b.length;
                for (c && (x = s === I || s || c); p !== C && null != (u = b[p]); p++) {
                    if (r && u) {
                        for (d = 0,
                        s || u.ownerDocument === I || (O(u),
                        a = !L); f = e[d++]; )
                            if (f(u, s || I, a)) {
                                l.push(u);
                                break
        ...
        var b, w, T, C, _, E, S, k, x, A, D, O, I, N, L, $, H, F, P, j = "sizzle" + 1 * new Date, M = e.document, R = 0, W = 0, q = n(), z = n(), B = n(), U = function(e, t) {
            return e === t && (D = !0),
            0
        }, V = {}.hasOwnProperty, X = [], Y = X.pop, G = X.push, K = X.push, Q = X.slice, Z = function(e, t) {
            for (var n = 0, i = e.length; n < i; n++)
                if (e[n] === t)
                    return n;
            return -1
        ...
        }, fe = /^(?:input|select|textarea|button)$/i, he = /^h\d$/i, pe = /^[^{]+\{\s*\[native \w/, ge = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, me = /[+~]/, ve = new RegExp("\\\\([\\da-f]{1,6}" + ee + "?|(" + ee + ")|.)","ig"), ye = function(e, t, n) {
            var i = "0x" + t - 65536;
        ...
        try {
            K.apply(X = Q.call(M.childNodes), M.childNodes),
        ...
        O = t.setDocument = function(e) {
            ...
            N = I.documentElement,
            L = !_(I),
            M !== I && (n = I.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)),
            ...
            w.getElementsByClassName = pe.test(I.getElementsByClassName),
            ...
            H = [],
            $ = [],
            (w.qsa = pe.test(I.querySelectorAll)) && (o(function(e) {
                N.appendChild(e).innerHTML = "<a id='" + j + "'></a><select id='" + j + "-\r\\' msallowcapture=''><option selected=''></option></select>",
                e.querySelectorAll("[msallowcapture^='']").length && $.push("[*^$]=" + ee + "*(?:''|\"\")"),
                e.querySelectorAll("[selected]").length || $.push("\\[" + ee + "*(?:value|" + J + ")"),
            ...
            t = pe.test(N.compareDocumentPosition),
            P = t || pe.test(N.contains) ? function(e, t) {
            ...
            : function(e, t) {
                ...
                if (!o || !r)
                    return e === I ? -1 : t === I ? 1 : o ? -1 : r ? 1 : A ? Z(A, e) - Z(A, t) : 0;
                if (o === r)
                    return s(e, t);
        ...
        t.matchesSelector = function(e, n) {
            ...
            n = n.replace(le, "='$1']"),
            w.matchesSelector && L && !B[n + " "] && (!H || !H.test(n)) && (!$ || !$.test(n)))
                try {
                    var i = F.call(e, n);
        ...
        (T = t.selectors = {
            ...
            filter: {
                ...
                CHILD: function(e, t, n, i, o) {
                    ...
                    : function(t, n, l) {
                        var c, u, d, f, h, p, g = r !== s ? "nextSibling" : "previousSibling", m = t.parentNode, v = a && t.nodeName.toLowerCase(), y = !l && !a, b = !1;
                        if (m) {
                            if (r) {
                                for (; g; ) {
                                    for (f = t; f = f[g]; )
                            ...
                            s && y) {
                                for (b = (h = (c = (u = (d = (f = m)[j] || (f[j] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] || [])[0] === R && c[1]) && c[2],
                            ...
                            b = h),
                            !1 === b)
                                for (; (f = ++h && f && f[g] || (b = h = 0) || p.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++b || (y && (d = f[j] || (f[j] = {}),
                                u = d[f.uniqueID] || (d[f.uniqueID] = {}),
                                u[e] = [R, b]),
                                f !== t)); )
                                    ;
                ...
                PSEUDO: function(e, n) {
                    ...
                    return r[j] ? r(n) : r.length > 1 ? (o = [e, e, "", n],
        ...
        k = t.select = function(e, t, n, i) {
            var o, r, s, a, l, u = "function" == typeof e && e, f = !i && E(e = u.selector || e);
            if (n = n || [],
            1 === f.length) {
            ...
            return (u || S(e, f))(i, t, !L, n, !t || me.test(e) && c(t.parentNode) || t),
            n
        }
        ,
    ...
    (pe.fn.init = function(e, t, n) {
        ...
        "string" == typeof e) {
            ...
            return (o = te.getElementById(i[2])) && (this[0] = o,
            this.length = 1),
            this
        }
    ...
    pe.each({
        ...
        pe.fn[e] = function(n, i) {
            ...
            this.length > 1 && (Ae[e] || pe.uniqueSort(o),
            xe.test(e) && o.reverse()),
            this.pushStack(o)
        }
    });
                ...
                then: function(t, i, o) {
                    function r(t, n, i, o) {
                        return function() {
                            var a = this
                              ...
                              , d = function() {
                                ...
                                if (!(t < s)) {
                                    ...
                                    pe.isFunction(d) ? o ? d.call(e, r(s, n, l, o), r(s, n, c, o)) : (s++,
                              ...
                              , f = o ? d : function() {
                                try {
                                    ...
                                    pe.Deferred.exceptionHook && pe.Deferred.exceptionHook(e, f.stackTrace),
                                    t + 1 >= s && (i !== c && (a = void 0,
                                    u = [e]),
                                    n.rejectWith(a, u))
                                }
                            ...
                            ;
                            t ? f() : (pe.Deferred.getStackHook && (f.stackTrace = pe.Deferred.getStackHook()),
                            e.setTimeout(f))
                        }
                    }
                    var s = 0;
                    return pe.Deferred(function(e) {
                        n[0][3].add(r(0, e, pe.isFunction(o) ? o : l, e.notifyWith)),
    ...
    "complete" === te.readyState || "loading" !== te.readyState && !te.documentElement.doScroll ? e.setTimeout(pe.ready) : (te.addEventListener("DOMContentLoaded", d),
    ...
    pe.extend({
        queue: function(e, t, n) {
            ...
            if (e)
                return t = (t || "fx") + "queue",
                i = $e.get(e, t),
                n && (!i || Array.isArray(n) ? i = $e.access(e, t, pe.makeArray(n)) : i.push(n)),
                i || []
        },
    ...
    pe.event = {
            ...
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(De) || [""]).length; c--; )
                    ...
                    h) {
                        ...
                        s && !f.length && (d.teardown && !1 !== d.teardown.call(e, p, m.handle) || pe.removeEvent(e, h, m.handle),
                        delete l[h])
                    } else
                        for (h in l)
        ...
        dispatch: function(e) {
            var t, n, i, o, r, s, a = pe.event.fix(e), l = new Array(arguments.length), c = ($e.get(this, "events") || {})[a.type] || [], u = pe.event.special[a.type] || {};
            for (l[0] = a,
            ...
            !u.preDispatch || !1 !== u.preDispatch.call(this, a)) {
                ...
                t = 0; (o = s[t++]) && !a.isPropagationStopped(); )
                    ...
                    n = 0; (r = o.handlers[n++]) && !a.isImmediatePropagationStopped(); )
                        ...
                        a.data = r.data,
                        void 0 !== (i = ((pe.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) && !1 === (a.result = i) && (a.preventDefault(),
                        a.stopPropagation()));
                ...
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                        ...
                        n = 0; n < l; n++)
                            i = t[n],
                            o = i.selector + " ",
                            void 0 === s[o] && (s[o] = i.needsContext ? pe(o, this).index(c) > -1 : pe.find(o, this, null, [c]).length),
                            s[o] && r.push(i);
                        r.length && a.push({
                            elem: c,
                            handlers: r
    ...
    pe.Event = function(e, t) {
        ...
        this.type = e.type,
        this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? T : C,
    ...
    pe.extend({
        ...
        clone: function(e, t, n) {
            var i, o, r, s, a = e.cloneNode(!0), l = pe.contains(e.ownerDocument, e);
    ...
    pe.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, r, s, a = pe.camelCase(t), l = lt.test(t), c = e.style;
                return l || (t = H(a)),
                s = pe.cssHooks[t] || pe.cssHooks[a],
                void 0 === n ? s && "get"in s && void 0 !== (o = s.get(e, !1, i)) ? o : c[t] : ("string" === (r = typeof n) && (o = Me.exec(n)) && o[1] && (n = g(e, t, o),
                r = "number"),
                void (null != n && n === n && ("number" === r && (n += o && o[3] || (pe.cssNumber[a] ? "" : "px")),
                fe.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"),
                s && "set"in s && void 0 === (n = s.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))))
            }
        },
        css: function(e, t, n, i) {
            var o, r, s, a = pe.camelCase(t);
            return lt.test(t) || (t = H(a)),
            (s = pe.cssHooks[t] || pe.cssHooks[a]) && "get"in s && (o = s.get(e, !0, n)),
            void 0 === o && (o = N(e, t, i)),
    ...
    pe.each(["height", "width"], function(e, t) {
        pe.cssHooks[t] = {
            get: function(e, n, i) {
                if (n)
                    return !at.test(pe.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? j(e, t, i) : qe(e, ct, function() {
                        return j(e, t, i)
                    })
            },
            set: function(e, n, i) {
                var o, r = i && st(e), s = i && P(e, t, i, "border-box" === pe.css(e, "boxSizing", !1, r), r);
                return s && (o = Me.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n,
                n = pe.css(e, t)),
                F(0, n, s)
            }
        }
    ...
    pe.cssHooks.marginLeft = L(fe.reliableMarginLeft, function(e, t) {
        if (t)
            return (parseFloat(N(e, "marginLeft")) || e.getBoundingClientRect().left - qe(e, {
                marginLeft: 0
            }, function() {
    ...
    pe.fx.step = {};
    var ht, pt, gt = /^(?:toggle|show|hide)$/, mt = /queueHooks$/;
    pe.Animation = pe.extend(U, {
        tweeners: {
            "*": [function(e, t) {
                var n = this.createTween(e, t);
                return g(n.elem, e, Me.exec(t), n),
                n
            }
            ]
        },
        ...
        prefilters: [function(e, t, n) {
            var i, o, r, s, a, l, c, u, d = "width"in t || "height"in t, f = this, h = {}, p = e.style, g = e.nodeType && We(e), m = $e.get(e, "fxshow");
            ...
            if ((l = !pe.isEmptyObject(t)) || !pe.isEmptyObject(h)) {
                ...
                u = pe.css(e, "display"),
                v([e]))),
                ("inline" === u || "inline-block" === u && null != c) && "none" === pe.css(e, "float") && (l || (f.done(function() {
                    p.display = c
                }),
                null == c && (u = p.display,
                c = "none" === u ? "" : u)),
                ...
                l = !1;
                for (i in h)
                    l || (m ? "hidden"in m && (g = m.hidden) : m = $e.access(e, "fxshow", {
                        display: c
                    }),
                    r && (m.hidden = !g),
                    g && v([e], !0),
    ...
    pe.fn.extend({
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"),
            this.each(function() {
                var t, n = $e.get(this), i = n[e + "queue"], o = n[e + "queueHooks"], r = pe.timers, s = i ? i.length : 0;
                for (n.finish = !0,
                pe.queue(this, e, []),
    ...
    pe.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r)
                return void 0 === e.getAttribute ? pe.prop(e, t, n) : (1 === r && pe.isXMLDoc(e) || (o = pe.attrHooks[t.toLowerCase()] || (pe.expr.match.bool.test(t) ? vt : void 0)),
                void 0 !== n ? null === n ? void pe.removeAttr(e, t) : o && "set"in o && void 0 !== (i = o.set(e, n, t)) ? i : (e.setAttribute(t, n + ""),
                n) : o && "get"in o && null !== (i = o.get(e, t)) ? i : null == (i = pe.find.attr(e, t)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : pe.isFunction(e) ? this.each(function(n) {
                ...
                if ("string" === n)
                    ...
                    void 0 !== e && "boolean" !== n || ((t = X(this)) && $e.set(this, "__className__", t),
    ...
    pe.extend({
        valHooks: {
            ...
            select: {
                get: function(e) {
                    var t, n, i, r = e.options, s = e.selectedIndex, a = "select-one" === e.type, l = a ? null : [], c = a ? s + 1 : r.length;
                ...
                set: function(e, t) {
                    for (var n, i, o = e.options, r = pe.makeArray(t), s = o.length; s--; )
                        i = o[s],
                        (i.selected = pe.inArray(pe.valHooks.option.get(i), r) > -1) && (n = !0);
    ...
    pe.extend(pe.event, {
        trigger: function(t, n, i, o) {
            var r, s, a, l, c, u, d, f = [i || te], h = ce.call(t, "type") ? t.type : t, p = ce.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = a = i = i || te,
            3 !== i.nodeType && 8 !== i.nodeType && !Ct.test(h + pe.event.triggered) && (h.indexOf(".") > -1 && (p = h.split("."),
            h = p.shift(),
            p.sort()),
            c = h.indexOf(":") < 0 && "on" + h,
            ...
            o || !d.trigger || !1 !== d.trigger.apply(i, n))) {
                ...
                for (r = 0; (s = f[r++]) && !t.isPropagationStopped(); )
                    ...
                    (u = c && s[c]) && u.apply && Le(s) && (t.result = u.apply(s, n),
                    !1 === t.result && t.preventDefault());
                return t.type = h,
                o || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(f.pop(), n) || !Le(i) || c && pe.isFunction(i[h]) && !pe.isWindow(i) && ((a = i[c]) && (i[c] = null),
    ...
    pe.extend({
        ...
        ajax: function(t, n) {
            function i(t, n, i, a) {
                ...
                i && (w = Z(p, _, i)),
                w = J(p, w, _, c),
                c ? (p.ifModified && ((T = _.getResponseHeader("Last-Modified")) && (pe.lastModified[r] = T),
                ...
                _.statusCode(b),
                b = void 0,
                d && m.trigger(c ? "ajaxSuccess" : "ajaxError", [_, p, c ? f : h]),
                y.fireWith(g, [_, C]),
            ...
            t = void 0),
            n = n || {};
            var o, r, s, a, l, c, u, d, f, h, p = pe.ajaxSetup({}, n), g = p.context || p, m = p.context && (g.nodeType || g.jquery) ? pe(g) : pe.event, v = pe.Deferred(), y = pe.Callbacks("once memory"), b = p.statusCode || {}, w = {}, T = {}, C = "canceled", _ = {
                readyState: 0,
            ...
            if (v.promise(_),
            p.url = ((t || p.url || _t.href) + "").replace(Ft, _t.protocol + "//"),
            ...
            null == p.crossDomain) {
                ...
                try {
                    c.href = p.url,
                    c.href = c.href,
                    p.crossDomain = Rt.protocol + "//" + Rt.host != c.protocol + "//" + c.host
                } catch (e) {
                    p.crossDomain = !0
                }
            }
            ...
            u)
                return _;
            (d = pe.event && p.global) && 0 == pe.active++ && pe.event.trigger("ajaxStart"),
            p.type = p.type.toUpperCase(),
            p.hasContent = !Ht.test(p.type),
            r = p.url.replace(It, ""),
            p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(Ot, "+")) : (h = p.url.slice(r.length),
            p.data && (r += (St.test(r) ? "&" : "?") + p.data,
            delete p.data),
            !1 === p.cache && (r = r.replace(Nt, "$1"),
            h = (St.test(r) ? "&" : "?") + "_=" + Et++ + h),
            p.url = r + h),
            p.ifModified && (pe.lastModified[r] && _.setRequestHeader("If-Modified-Since", pe.lastModified[r]),
    ...
    pe.ajaxPrefilter("json jsonp", function(t, n, i) {
        ...
        if (a || "jsonp" === t.dataTypes[0])
            ...
            a ? t[a] = t[a].replace(Bt, "$1" + o) : !1 !== t.jsonp && (t.url += (St.test(t.url) ? "&" : "?") + t.jsonp + "=" + o),
            t.converters["script json"] = function() {
                return s || pe.error(o + " was not called"),
                s[0]
            }
            ,
            t.dataTypes[0] = "json",
    ...
    pe.offset = {
        setOffset: function(e, t, n) {
            var i, o, r, s, a, l, c = pe.css(e, "position"), u = pe(e), d = {};
            "static" === c && (e.style.position = "relative"),
            a = u.offset(),
            r = pe.css(e, "top"),
            l = pe.css(e, "left"),
            ("absolute" === c || "fixed" === c) && (r + l).indexOf("auto") > -1 ? (i = u.position(),
            s = i.top,
    ...
    pe.each({
        ...
        pe.fn[e] = function(i) {
            return Ne(this, function(e, i, o) {
                var r;
                return pe.isWindow(e) ? r = e : 9 === e.nodeType && (r = e.defaultView),
    ...
    pe.each(["top", "left"], function(e, t) {
        pe.cssHooks[t] = L(fe.pixelPosition, function(e, n) {
            if (n)
                return n = N(e, t),
                rt.test(n) ? pe(e).position()[t] + "px" : n
        })
    }),
    pe.each({
        Height: "height",
...
function(e, t) {
    ...
    var S = null
      ...
      , A = function() {
        var e = S;
        e && document.body.contains(e) || ((e = document.createElement("div")).setAttribute("data-tether-id", k()),
        u(e.style, {
            top: 0,
            left: 0,
            position: "absolute"
    ...
    var R = {
      ...
      , X = function(e) {
        function t(e) {
            var n = this;
            i(this, t),
            H(Object.getPrototypeOf(t.prototype), "constructor", this).call(this),
        ...
        _(t, [{
            ...
            value: function() {
                ...
                if ("scroll-handle" === this.targetModifier) {
                    ...
                    return r.top = l * (o - r.height - s) + e.top + parseFloat(n.borderTopWidth),
                    this.target === document.body && (r.height = Math.max(r.height, 24)),
                    r
                }
            }
            ...
            value: function(e, t) {
                ...
                I(function() {
                    void 0 !== n._addAttachClasses && (m(n.element, n._addAttachClasses, r),
                    !1 !== n.options.addTargetClasses && m(n.target, n._addAttachClasses, r),
            ...
            value: function() {
                ...
                if (this.enabled) {
                    ...
                    for (var m = u.left + h.left - f.left, v = u.top + h.top - f.top, y = 0; y < E.modules.length; ++y) {
                        ...
                        if (!1 === b)
                            return !1;
                        void 0 !== b && "object" == typeof b && (v = b.top,
                        m = b.left)
                    }
                    var C = {
                        page: {
                      ...
                      , S = _.defaultView
                      , k = void 0;
                    return S.innerHeight > _.documentElement.clientHeight && (k = this.cache("scrollbar-size", c),
                    C.viewport.bottom -= k.height),
                    S.innerWidth > _.documentElement.clientWidth && (k = this.cache("scrollbar-size", c),
                    C.viewport.right -= k.width),
                    -1 !== ["", "static"].indexOf(_.body.style.position) && -1 !== ["", "static"].indexOf(_.body.parentElement.style.position) || (C.page.bottom = _.body.scrollHeight - v - r,
                    ...
                    void 0 !== this.options.optimizations && !1 !== this.options.optimizations.moveElement && void 0 === this.targetModifier && function() {
                        ...
                        n.right = _.body.scrollWidth - n.left - o.width + r.right,
                        n.bottom = _.body.scrollHeight - n.top - o.height + r.bottom,
            ...
            value: function(e) {
                ...
                if (void 0 !== this.element.parentNode) {
                    ...
                    var c = {
                      ...
                      , d = function(e, n) {
                        if (!1 !== (void 0 !== t.options.optimizations ? t.options.optimizations.gpu : null)) {
                            ...
                            i = Math.round(i))),
                            c[P] = "translateX(" + o + "px) translateY(" + i + "px)",
                    ...
                    d(n.viewport, e.viewport)) : void 0 !== n.offset && n.offset.top && n.offset.left ? function() {
                        c.position = "absolute";
        ...
        position: function(e) {
            ...
            return this.options.constraints.forEach(function(e) {
                ...
                if (a.indexOf(" ") >= 0) {
                    ...
                    u = d = a;
                var b = C(t, r);
                "target" !== d && "both" !== d || (n < b[1] && "top" === v.top && (n += f,
                v.top = "bottom"),
                n + s > b[3] && "bottom" === v.top && (n -= f,
                v.top = "top")),
                "together" === d && ("top" === v.top && ("bottom" === y.top && n < b[1] ? (n += f,
                v.top = "bottom",
                n += s,
                y.top = "top") : "top" === y.top && n + s > b[3] && n - (s - f) >= b[1] && (n -= s - f,
                v.top = "bottom",
                y.top = "bottom")),
                "bottom" === v.top && ("top" === y.top && n + s > b[3] ? (n -= f,
                v.top = "top",
                n -= s,
                ...
                y.top = "top"))),
                "target" !== u && "both" !== u || (i < b[0] && "left" === v.left && (i += h,
                v.left = "right"),
                i + l > b[2] && "right" === v.left && (i -= h,
                v.left = "left")),
                "together" === u && (i < b[0] && "left" === v.left ? "right" === y.left ? (i += h,
                v.left = "right",
                i += l,
                y.left = "left") : "left" === y.left && (i += h,
                v.left = "right",
                i -= l,
                y.left = "right") : i + l > b[2] && "right" === v.left ? "left" === y.left ? (i -= h,
                v.left = "left",
                i -= l,
                ...
                w.push("top")) : T.push("top")),
                n + s > b[3] && (c.indexOf("bottom") >= 0 ? (n = b[3] - s,
                w.push("bottom")) : T.push("bottom")),
                i < b[0] && (c.indexOf("left") >= 0 ? (i = b[0],
                w.push("left")) : T.push("left")),
                i + l > b[2] && (c.indexOf("right") >= 0 ? (i = b[2] - l,
                w.push("right")) : T.push("right")),
                w.length && function() {
                    var e = void 0;
...
function() {
    ...
    : function(e) {
      ...
      , s = (function(e) {
        var t = "alert"
          ...
          , d = function() {
            ...
            t.prototype._removeElement = function(t) {
                ...
                r.supportsTransitionEnd() && e(t).hasClass(u.FADE) ? void e(t).one(r.TRANSITION_END, function(e) {
        ...
        e(document).on(c.CLICK_DATA_API, l.DISMISS, d._handleDismiss(new d)),
    ...
    function(e) {
        ...
        e(document).on(u.CLICK_DATA_API, c.DATA_TOGGLE_CARROT, function(t) {
            t.preventDefault();
            var n = t.target;
            e(n).hasClass(l.BUTTON) || (n = e(n).closest(c.BUTTON)),
    ...
    function(e) {
        var t = "carousel"
          ...
          , m = function() {
            ...
            l.prototype.pause = function(t) {
                t || (this._isPaused = !0),
                e(this._element).find(g.NEXT_PREV)[0] && r.supportsTransitionEnd() && (r.triggerTransitionEnd(this._element),
                this.cycle(!0)),
            ...
            l.prototype._getItemIndex = function(t) {
                return this._items = e.makeArray(e(t).parent().find(g.ITEM)),
            ...
            l.prototype._slide = function(t, n) {
                var i = this
                  ...
                  , c = void 0
                  , u = void 0;
                if (t === f.NEXT ? (l = p.LEFT,
                c = p.NEXT,
                u = f.LEFT) : (l = p.RIGHT,
                c = p.PREV,
                u = f.RIGHT),
                s && e(s).hasClass(p.ACTIVE))
                    this._isSliding = !1;
                    ...
                    r.supportsTransitionEnd() && e(this._element).hasClass(p.SLIDE) ? (e(s).addClass(c),
                    r.reflow(s),
                    e(o).addClass(l),
                    e(s).addClass(l),
                    e(o).one(r.TRANSITION_END, function() {
                        e(s).removeClass(l + " " + c).addClass(p.ACTIVE),
                        e(o).removeClass(p.ACTIVE + " " + c + " " + l),
                        i._isSliding = !1,
                        setTimeout(function() {
                            return e(i._element).trigger(d)
                        }, 0)
                    }).emulateTransitionEnd(600)) : (e(o).removeClass(p.ACTIVE),
                    e(s).addClass(p.ACTIVE),
                    this._isSliding = !1,
        ...
        e(document).on(h.CLICK_DATA_API, g.DATA_SLIDE, m._dataApiClickHandler),
          ...
          , g = function() {
            ...
            a.prototype.show = function() {
                ...
                if (!e(this._element).hasClass(f.SHOW)) {
                    var n = void 0
                      , i = void 0;
                    if (this._parent && ((n = e.makeArray(e(this._parent).find(p.ACTIVES))).length || (n = null)),
                    !(n && (i = e(n).data(s)) && i._isTransitioning)) {
                        var o = e.Event(d.SHOW);
                        if (e(this._element).trigger(o),
                        !o.isDefaultPrevented()) {
                            n && (a._jQueryInterface.call(e(n), "hide"),
                            i || e(n).data(s, null));
                            ...
                            var c = function() {
                                e(t._element).removeClass(f.COLLAPSING).addClass(f.COLLAPSE).addClass(f.SHOW),
                                t._element.style[l] = "",
                            ...
                            e(this._element).one(r.TRANSITION_END, c).emulateTransitionEnd(600),
            ...
            a.prototype.hide = function() {
                ...
                if (e(this._element).hasClass(f.SHOW)) {
                    ...
                    !n.isDefaultPrevented()) {
                        ...
                        var s = function() {
                            t.setTransitioning(!1),
                            e(t._element).removeClass(f.COLLAPSING).addClass(f.COLLAPSE).trigger(d.HIDDEN)
                        };
                        return this._element.style[i] = "",
                        r.supportsTransitionEnd() ? void e(this._element).one(r.TRANSITION_END, s).emulateTransitionEnd(600) : void s()
                    }
                }
            }
            ,
            ...
            a.prototype._getConfig = function(n) {
                return n = e.extend({}, c, n),
                n.toggle = Boolean(n.toggle),
                r.typeCheckConfig(t, n, u),
                n
            }
            ,
            ...
            a._jQueryInterface = function(t) {
                return this.each(function() {
                    ...
                    if (!o && r.toggle && /show|hide/.test(t) && (r.toggle = !1),
                    o || (o = new a(this,r),
                    n.data(s, o)),
                    "string" == typeof t) {
                        if (void 0 === o[t])
                ...
                if (!n || 3 !== n.which) {
                    ...
                    for (var o = e.makeArray(e(d.DATA_TOGGLE)), r = 0; r < o.length; r++) {
                        ...
                        if (e(s).hasClass(u.SHOW) && !(n && ("click" === n.type && /input|textarea/i.test(n.target.tagName) || "focusin" === n.type) && e.contains(s, n.target))) {
                            ...
                            e(s).removeClass(u.SHOW).trigger(e.Event(c.HIDDEN, a)))
                        }
                    }
                }
            }
    ...
    function(e) {
        var t = "modal"
          ...
          , p = function() {
            ...
            l.prototype.dispose = function() {
                e.removeData(this._element, s),
                e(window, document, this._element, this._backdrop).off(a),
                this._config = null,
                this._element = null,
                this._dialog = null,
                this._backdrop = null,
        ...
        var t = "scrollspy"
          ...
          , g = function() {
            function l(t, i) {
                ...
                e(this._scrollElement).on(d.SCROLL, function(e) {
                    return o._process(e)
                }),
                this.refresh(),
                this._process()
            ...
            return l.prototype.refresh = function() {
                ...
                e.makeArray(e(this._selector)).map(function(t) {
                    ...
                    return s && (n = e(s)[0]),
                    n && (n.offsetWidth || n.offsetHeight) ? [e(n)[i]().top + o, s] : null
                }).filter(function(e) {
                    return e
                }).sort(function(e, t) {
                    return e[0] - t[0]
            ...
            l.prototype._getConfig = function(n) {
                ...
                return r.typeCheckConfig(t, n, u),
                n
            }
            ,
            ...
            l.prototype._activate = function(t) {
                ...
                var i = e(n.join(","));
                i.hasClass(f.DROPDOWN_ITEM) ? (i.closest(h.DROPDOWN).find(h.DROPDOWN_TOGGLE).addClass(f.ACTIVE),
                i.addClass(f.ACTIVE)) : i.parents(h.LI).find("> " + h.NAV_LINKS).addClass(f.ACTIVE),
          ...
          , d = function() {
            ...
            return t.prototype.show = function() {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && e(this._element).hasClass(c.ACTIVE) || e(this._element).hasClass(c.DISABLED))) {
                    ...
                    o && (i = e.makeArray(e(o).find(u.ACTIVE)),
                    i = i[i.length - 1]);
            ...
            t.prototype._activate = function(t, n, i) {
                ...
                s && a ? e(s).one(r.TRANSITION_END, l).emulateTransitionEnd(150) : l(),
                s && e(s).removeClass(c.SHOW)
            }
            ,
            t.prototype._transitionComplete = function(t, n, i, o) {
                if (n) {
                    ...
                    s && e(s).removeClass(c.ACTIVE),
                    n.setAttribute("aria-expanded", !1)
                }
                if (e(t).addClass(c.ACTIVE),
                t.setAttribute("aria-expanded", !0),
                i ? (r.reflow(t),
                e(t).addClass(c.SHOW)) : e(t).removeClass(c.FADE),
                t.parentNode && e(t.parentNode).hasClass(c.DROPDOWN_MENU)) {
                    var a = e(t).closest(u.DROPDOWN)[0];
                    a && e(a).find(u.DROPDOWN_TOGGLE).addClass(c.ACTIVE),
                    t.setAttribute("aria-expanded", !0)
                }
                o && o()
            }
          ...
          , y = function() {
            ...
            l.prototype.show = function() {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    e(o).data(this.constructor.DATA_KEY, this).appendTo(u),
                    ...
                    if (r.supportsTransitionEnd() && e(this.tip).hasClass(p.FADE))
                        return this._isTransitioning = !0,
                        void e(this.tip).one(r.TRANSITION_END, d).emulateTransitionEnd(l._TRANSITION_DURATION);
                    d()
                }
            }
            ,
            l.prototype.hide = function(t) {
                ...
                o.isDefaultPrevented() || (e(i).removeClass(p.SHOW),
                this._activeTrigger[v.CLICK] = !1,
                this._activeTrigger[v.FOCUS] = !1,
                this._activeTrigger[v.HOVER] = !1,
                r.supportsTransitionEnd() && e(this.tip).hasClass(p.FADE) ? (this._isTransitioning = !0,
                e(i).one(r.TRANSITION_END, s).emulateTransitionEnd(150)) : s(),
                this._hoverState = "")
            }
            ,
            ...
            l.prototype.setContent = function() {
                ...
                this.setElementContent(t.find(g.TOOLTIP_INNER), this.getTitle()),
            ...
            l.prototype._enter = function(t, n) {
                ...
                e(n.getTipElement()).hasClass(p.SHOW) || n._hoverState === f.SHOW ? void (n._hoverState = f.SHOW) : (clearTimeout(n._timeout),
            ...
            l.prototype._getConfig = function(n) {
                ...
                r.typeCheckConfig(t, n, this.constructor.DefaultType),
                n
            }
            ,
            ...
            l._jQueryInterface = function(t) {
                return this.each(function() {
                    var n = e(this).data(s)
                      , o = "object" === (void 0 === t ? "undefined" : i(t)) && t;
                    if ((n || !/dispose|hide/.test(t)) && (n || (n = new l(this,o),
                    e(this).data(s, n)),
                    "string" == typeof t)) {
                        if (void 0 === n[t])
                            throw new Error('No method named "' + t + '"');
          ...
          , m = function(s) {
            ...
            u._jQueryInterface = function(e) {
                return this.each(function() {
                    ...
                    if ((t || !/destroy|hide/.test(e)) && (t || (t = new u(this,n),
                    r(this).data(l, t)),
                    "string" == typeof e)) {
                        if (void 0 === t[e])
...
function(e, t) {
    ...
    function i(o, r) {
        ...
        h.length || (console.warn("isInViewport: The viewport selector you have provided matches no element on page."),
        ...
        return d.tolerance = ~~Math.round(parseFloat(d.tolerance)),
        d.tolerance < 0 && (d.tolerance = p + d.tolerance),
        u <= 0 || c >= g ? f : f = d.tolerance ? a <= d.tolerance && l >= d.tolerance : l > 0 && a <= p
    }
    function o(t) {
        if (t) {
            var n = t.split(",");
            return 1 === n.length && isNaN(n[0]) && (n[1] = n[0],
            n[0] = void 0),
            {
    ...
    e.fn.run = function(t) {
        var n = this;
        if (1 === arguments.length && "function" == typeof t && (t = [t]),
        !(t instanceof Array))
        ...
        return t.forEach(function(t) {
            ...
            console.warn("isInViewport: Ignoring non-function values in array and moving on")) : [].slice.call(n).forEach(function(n) {
                return t.call(e(n))
            })
        }),
        this
...
function(e, t) {
    ...
    return function(e) {
        ...
        n(5)))
          ...
          , m = function() {
            return !(arguments.length <= 0 || void 0 === arguments[0]) && arguments[0] && (h = !0),
            h ? (f = (0,
            u.default)(f, g),
            (0,
            c.default)(f, g.once),
        ...
        e.exports = {
            init: function(e) {
                ...
                f = (0,
                d.default)(),
                b(g.disable) || p ? y() : (document.querySelector("body").setAttribute("data-aos-easing", g.easing),
                ...
                "DOMContentLoaded" === g.startEvent && ["complete", "interactive"].indexOf(document.readyState) > -1 ? m(!0) : document.addEventListener(g.startEvent, function() {
                    m(!0)
                }),
    ...
    , function(e, t) {
        ...
        e.exports = function(e, t, n) {
            ...
            function f() {
                ...
                return void 0 === v && (v = setTimeout(u, t)),
                m
            }
            var h, p, g, m, v, y = 0, C = 0, _ = !1, E = !1, S = !0;
            if ("function" != typeof e)
                throw new TypeError(l);
            return t = s(t) || 0,
            i(n) && (_ = !!n.leading,
            E = "maxWait"in n,
            g = E ? b(s(n.maxWait) || 0, t) : g,
    ...
    , function(e, t) {
        ...
        function n() {
            for (var e, t, n = 0, o = r.length; o > n; n++) {
                e = r[n];
                for (var s, a = 0, l = (t = i.querySelectorAll(e.selector)).length; l > a; a++)
                    (s = t[a]).ready || (s.ready = !0,
                    e.fn.call(s, s))
            }
        }
...
function(e) {
    e.fn.countdown = function(t, n) {
        function i() {
            eventDate = Date.parse(o.date) / 1e3,
            ...
            "on" == o.format && (days = String(days).length >= 2 ? days : "0" + days,
            hours = String(hours).length >= 2 ? hours : "0" + hours,
            minutes = String(minutes).length >= 2 ? minutes : "0" + minutes,
            seconds = String(seconds).length >= 2 ? seconds : "0" + seconds),
            isNaN(eventDate) ? (alert("Invalid date. Here's an example: 12 Tuesday 2016 17:30:00"),
...
function(e) {
    ...
    t.prototype.cleanUpEvents = function() {
        ...
        !0 === t.options.accessibility && (t.$prevArrow.off("keydown.slick", t.keyHandler),
    ...
    t.prototype.postSlide = function(t) {
        ...
        !0 === n.options.accessibility && (n.initADA(),
        n.options.autoplay || e(n.$slides.get(n.currentSlide)).attr("tabindex", 0).focus()))
    }
    ,
...
function(e) {
    ...
    e.extend(e.fn, {
        ...
        rules: function(t, n) {
            ...
            return (s = e.validator.normalizeRules(e.extend({}, e.validator.classRules(c), e.validator.attributeRules(c), e.validator.dataRules(c), e.validator.staticRules(c)), c)).required && (a = s.required,
            delete s.required,
            s = e.extend({
                required: a
            }, s),
    ...
    e.extend(e.validator, {
        ...
        prototype: {
            ...
            element: function(t) {
                ...
                (o = !1 !== this.check(i)) ? delete this.invalid[i.name] : this.invalid[i.name] = !0),
            ...
            check: function(t) {
                ...
                var n, i, o, r = e(t).rules(), s = e.map(r, function(e, t) {
                    return t
            ...
            showLabel: function(t, n) {
                ...
                s.html(n)) : (i = s = e("<" + this.settings.errorElement + ">").attr("id", a + "-error").addClass(this.settings.errorClass).html(n || ""),
                ...
                s.is("label") ? s.attr("for", a) : 0 === s.parents("label[for='" + a + "']").length && (r = s.attr("id").replace(/(:|\.|\[|\])/g, "\\$1"),
                l ? l.match(new RegExp("\\b" + r + "\\b")) || (l += " " + r) : l = r,
                e(t).attr("aria-describedby", l),
                (o = this.groups[t.name]) && e.each(this.groups, function(t, n) {
        ...
        dataRules: function(t) {
            var n, i, o = {}, r = e(t);
            for (n in e.validator.methods)
                void 0 !== (i = r.data("rule" + n.charAt(0).toUpperCase() + n.substring(1).toLowerCase())) && (o[n] = i);
            return o
        },
            ...
            remote: function(t, n, i) {
                ...
                e.ajax(e.extend(!0, {
                    ...
                    success: function(i) {
                        ...
                        o.showErrors()) : (r = {},
                        a = i || o.defaultMessage(n, "remote"),
                        r[n.name] = s.message = e.isFunction(a) ? a(t) : a,
                        o.invalid[n.name] = !0,
                        o.showErrors(r)),
                        s.valid = c,
                        o.stopRequest(n, c)
    ...
    e.submit(function(e) {
        ...
        submitHandler: function(i) {
            ...
            var o = e.data("redirect")
              , r = !1;
            "none" != o && "" != o && null != o || (r = !0),
            n.html('<p class="help-block">Please wait...</p>');
            ...
            return $.ajax({
                ...
                cache: !1,
                success: function(i) {
                    "success" == i ? r ? (e[0].reset(),
                    n.fadeIn("slow").html('<div class="mt-3 help-block text-success">' + s + "</div>").delay(3e3).fadeOut("slow")) : window.location.href = o : (n.fadeIn("slow").html('<div class="mt-3 help-block text-danger">' + a + "</div>").delay(3e3).fadeOut("slow"),
                    window.console && console.log("PHP Error: " + i)),
                    t.attr("disabled", !1)
                },
                error: function(e) {
                    n.fadeIn("slow").html('<div class="mt-3 help-block text-danger"> Cannot access Server</div>').delay(3e3).fadeOut("slow"),
                    t.attr("disabled", !1),
                    window.console && console.error("JS Error: Please make sure you are running on a PHP Server")
                }
            }),
            !1
        }
    ...
    $("#subscribeform").submit(function(e) {
        ...
        submitHandler: function(e) {
            ...
            var i = $("#subscribeform").data("redirect")
              , o = !1;
            "none" != i && "" != i && null != i || (o = !0),
            n.fadeIn("slow").html('<p class="help-block">Please wait...</p>');
            ...
            return $.ajax({
                ...
                success: function(e) {
                    ...
                    "success" == e ? o ? n.fadeIn("slow").html('<p class="mt-3 help-block text-success">' + r + "</p>").delay(3e3).fadeOut("slow") : window.location.href = i : (n.fadeIn("slow").html('<p class="mt-3 help-block text-danger">' + s + "</p>").delay(3e3).fadeOut("slow"),
                    window.console && console.log("PHP Error: " + e)),
                    t.attr("disabled", !1)
                },
                error: function(e) {
                    n.fadeIn("slow").html('<p class="mt-3 help-block text-danger"> Sorry. Cannot access the PHP Server</p>').delay(3e3).fadeOut("slow"),
                    t.attr("disabled", !1)
                }
            }),
            !1
...
$(window).on("load", function() {
    ...
    loadGoogleMapsAPI(),
    $("#bg-slider").length && $.fn.slick && ($(".slick-slide .img-holder").height($(window).height()),
